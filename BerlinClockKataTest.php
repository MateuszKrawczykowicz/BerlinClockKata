...
class BerlinClockKataTest extends TestCase
{
    ...
    public function testSimpleHourShouldReturnTwoY(){
        $firstLight = new BerlinClockKata();
        $actual = $firstLight->simpleHour("02:53:05");
        $this->assertEquals("Y Y O O ", $actual);
    }

    public function testSimpleHourShouldReturnThreeY(){
        $firstLight = new BerlinClockKata();
        $actual = $firstLight->simpleHour("13:53:05");
        $this->assertEquals("Y Y Y O ", $actual);
    }

    public function testSimpleHourShouldReturnFourY(){
        $firstLight = new BerlinClockKata();
        $actual = $firstLight->simpleHour("14:53:05");
        $this->assertEquals("Y Y Y Y ", $actual);
    }
